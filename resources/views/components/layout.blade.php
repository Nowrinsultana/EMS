                            ...
                            <div class="relative" id="notif-dropdown">
                                <button id="notif-dropdown-btn"
                                    ...
                                    <span class="relative block" style="width:20px;height:20px;">
                                        ...
                                        @if ($unreadCount > 0)
                                            <span class="absolute flex items-center justify-center w-[18px] h-[18px] text-xs font-bold text-white bg-red-500 rounded-full" style="top:-4px;right:-4px;">{{ min($unreadCount, 99) }}</span>
                                        @endif
                                    </span>
                                </button>
