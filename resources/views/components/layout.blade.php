                            ...
                            <div class="relative" id="notif-dropdown">
                                <button id="notif-dropdown-btn"
                                    ...
                                    <span class="relative inline-flex">
                                        ...
                                        @if ($unreadCount > 0)
                                            <span class="absolute -top-1 -right-1 flex items-center justify-center min-w-[18px] h-[18px] px-0.5 text-xs font-bold text-white bg-red-500 rounded-full">{{ min($unreadCount, 99) }}</span>
                                        @endif
                                    </span>
                                </button>
